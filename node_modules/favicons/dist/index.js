...
function favicons(source) {
  ...
  return options.pipeHTML ? result.then(function (response) {
    return µ.Files.create(response.html, options.html, true).then(function (file) {
      return Object.assign(response, {
        files: [].concat(_toConsumableArray(response.files), [file])
      });
    });
  }) : result;
}
...
function stream(params, handleHtml) {
  ...
  return through2.obj(function (file, encoding, callback) {
    ...
    favicons(file.contents, params).then(function (_ref8) {
      ...
      for (var _i2 = 0, _arr2 = [].concat(_toConsumableArray(images), _toConsumableArray(files)); _i2 < _arr2.length; _i2++) {
        var asset = _arr2[_i2];
